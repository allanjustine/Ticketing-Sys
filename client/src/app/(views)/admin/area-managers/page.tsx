...
import { AREA_MANAGERS_COLUMNS } from "../_constants/area-managers-columns";
import SearchInput from "@/components/ui/search-input";
import { useState } from "react";
import EditAreaManagerDialog from "../_components/_area-manager-dialogs/edit-area-manager";
...
function AreaManagers() {
  ...
  const AREA_MANAGERS_COLUMNS_ACTIONS = [
    {
      name: "Action",
      cell: (row: any) => (
